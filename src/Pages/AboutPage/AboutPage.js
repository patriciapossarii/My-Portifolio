...
import {
    Flex, Image, Box, Text, useBreakpointValue, useColorModeValue,
    Card, CardHeader, CardBody, CardFooter, Heading, Stack, StackDivider,
    Fade, ScaleFade, Slide, SlideFade, useDisclosure, Button, Collapse, Link
                ...
                <Flex flexDir={"row"} >
                    <Box marginLeft={"60px"}  >
                        ...
                        <Text fontSize={"2xl"} marginTop={"-600px"} textAlign={"left"} lineHeight={"50px"}>
                            ...
                            Sou desenvolvedora front-end, graduanda em Sistemas de Informação e estudante BootCamp Full Stack.
                            Tenho conhecimento nas tecnologias HTML, JavaScript, CSS e React assim como projetos realizados nestas linguagens.
                            <br />
                            ...
                            <p>A área de tecnologia para mim é essencial e criativa. Cada projeto possui suas particularidades e desafios, o que torna ainda mais empolgante. Um dos mais recentes que realizei foi de uma loja, "The Force Store" , em que consiste mostrar na Home page uma lista de produtos, em que podemos realizar filtros(valor, categoria, buscar por nome do produto, ordem crescente e decrescente ) e ao clicar em comprar no
                                item, o mesmo é adicionado em um carrinho. Este projeto foi feito em React com Design System "Chakra".</p>

                        </Text>
                    </Box>
                    <Flex flexDir={"row"} marginRight={"20px"} marginTop={"-500px"} width={"350%"} >

                        <Card minW={"50%"} marginLeft={"20px"} gap={"20px"}>
                            <CardHeader>
                            ...
                            <Stack marginBlock={"60px"} marginLeft={"20px"} gap={"20px"}>
                                <Heading size='md' >Kknowledge</Heading>
